      ...
      <div className={style.contact_wrapper}>
        ...
        <div className={style.contact_inner_wrapper}>
          <div className={style.left_card}>
            <p>
              Ready to transform your property into a profitable asset? Partner
              with PrimeCare Properties and experience the ease of success. Let
              us handle the intricacies while you enjoy the rewards of
